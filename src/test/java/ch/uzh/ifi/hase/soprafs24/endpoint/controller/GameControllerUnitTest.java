...
public class GameControllerUnitTest {
    ...
    public void updateSettings() throws Exception {
        ...
        verify(gameService, Mockito.times(1)).updateSettings(Mockito.matches(gameId), Mockito.notNull(),
                Mockito.notNull());
        verify(gameService, Mockito.times(0)).updateSettings(Mockito.matches("somethingElse"), Mockito.notNull(),
                Mockito.notNull());
    }
    ...
    public void leaveGameTest() throws Exception {
        ...
        verify(gameService, Mockito.times(0)).leaveGame(Mockito.matches("somethingElse"), Mockito.matches(playerId));
    }
    ...
    public void joinGameTest() throws Exception {
        ...
        verify(gameService, Mockito.times(0)).joinGame(Mockito.matches("somethingElse"), Mockito.matches(displayName));
    }
    ...
    public void makeGuessTest() throws Exception {
        ...
        verify(gameService, Mockito.times(1)).submitAnswer(Mockito.matches(gameId), Mockito.any(), Mockito.any());
    }
